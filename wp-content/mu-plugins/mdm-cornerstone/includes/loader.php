...
class Loader {
	...
	public function register( $object ) {
		// Register Actions
		if ( $object instanceof \Mdm\Cornerstone\Interfaces\Action_Hook_Subscriber ) {
			$this->register_actions( $object );
		}
		// Register Filters
		if ( $object instanceof \Mdm\Cornerstone\Interfaces\Filter_Hook_Subscriber ) {
			$this->register_filters( $object );
		}
		// Register Shortcodes
		if ( $object instanceof \Mdm\Cornerstone\Interfaces\Shortcode_Hook_Subscriber ) {
	 ...
	 */
	private function register_action( \Mdm\Cornerstone\Interfaces\Action_Hook_Subscriber $object, $name, $parameters ) {
		// For string params
	 ...
	 */
	private function register_actions( \Mdm\Cornerstone\Interfaces\Action_Hook_Subscriber $object ) {
	 ...
	 * @param mixed                           $parameters
	 */
	private function register_filter( \Mdm\Cornerstone\Interfaces\Filter_Hook_Subscriber $object, $name, $parameters ) {
	 ...
	 * @param Filter_Hook_SubscriberInterface $object
	 */
	private function register_filters( \Mdm\Cornerstone\Interfaces\Filter_Hook_Subscriber $object) {
	 ...
	 * @param mixed                           $parameters
	 */
	private function register_shortcode( \Mdm\Cornerstone\Interfaces\Shortcode_Hook_Subscriber $object, $name, $parameters ) {
		if( is_string( $parameters ) ) {
			// If a class method
			if( method_exists( $object, $parameters ) ) {
	 ...
	 * @param Shortcode_Hook_SubscriberInterface $object
	 */
	private function register_shortcodes( \Mdm\Cornerstone\Interfaces\Shortcode_Hook_Subscriber $object) {
